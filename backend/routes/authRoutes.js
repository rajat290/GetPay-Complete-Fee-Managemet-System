...
const { registerStudent, loginStudent, getProfile, requestPasswordReset, resetPassword, activateAccount, changePassword, logout } = require('../controllers/authController');

...
import { FiActivity, FiBriefcase, FiGlobe, FiHome, FiInbox, FiLogOut, FiMessageSquare, FiShield } from "react-icons/fi";
...
const navigation = [
  ...
  { name: "Communications", href: "/super-admin/communications", icon: FiMessageSquare },
  { name: "Activity Logs", href: "/super-admin/audits", icon: FiActivity }
];
